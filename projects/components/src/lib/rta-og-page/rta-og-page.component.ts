...
@Component({
  selector: 'sol-rta-og-page',
  imports: [CommonModule, AlertLeftPanelComponent, AlertRightPanelComponent],
  standalone: true,
  templateUrl: './rta-og-page.component.html',
  styleUrls: ['./rta-og-page.component.css'],
  providers: [RtaApiService]
})
export class RtaOgPageComponent implements OnInit, OnChanges {
